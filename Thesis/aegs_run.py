...
'''
    NOTE:
    This project uses pre-write files, if they are not in this directory you have to call util.create_csv_files()
    Please first read comments in util class
'''
...
def predict():
    ...
    selected_topic = "Computer"

    aegs.predict(essay, selected_topic)
