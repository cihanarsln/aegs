...
def find_word_count(essay):
    ...
    for i in range(len(essay)):
        ...
        if enc.check(essay[i]):
            ...
            tag = str(tag[0][1])
            if tag == 'JJ': words_counts[3] = words_counts[3] + 1
            elif tag == 'JJR': words_counts[4] = words_counts[4] + 1
            elif tag == 'JJS': words_counts[5] = words_counts[5] + 1
            elif tag == 'NN': words_counts[6] = words_counts[6] + 1
            elif tag == 'NNP': words_counts[7] = words_counts[7] + 1
            elif tag == 'NNS': words_counts[8] = words_counts[8] + 1
            elif tag == 'NNPS': words_counts[9] = words_counts[9] + 1
            elif tag == 'RB': words_counts[10] = words_counts[10] + 1
            elif tag == 'RBR': words_counts[11] = words_counts[11] + 1
            elif tag == 'RBS': words_counts[12] = words_counts[12] + 1
            elif tag == 'VB': words_counts[13] = words_counts[13] + 1
            elif tag == 'VBD': words_counts[14] = words_counts[14] + 1
            elif tag == 'VBG': words_counts[15] = words_counts[15] + 1
            elif tag == 'VBP': words_counts[16] = words_counts[16] + 1
            elif tag == 'VBZ': words_counts[17] = words_counts[17] + 1
            else: words_counts[18] = words_counts[18] + 1
        else: non_eng = non_eng + 1
    non_eng = round((non_eng - (labeled * 2)) * 2 / 3)
    words_counts[1] = eng
    words_counts[2] = non_eng
    return words_counts
